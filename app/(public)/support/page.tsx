...
const SUPPORT_CHANNELS = [
  { icon: MessageSquare, title: "Live Chat", desc: "Real-time communication with our dedicated support team.", color: "bg-blue-50 text-blue-600", border: "hover:border-blue-200" },
  { icon: LifeBuoy, title: "Specialist Support", desc: "Submit complex technical or patent-related inquiries for expert review.", color: "bg-emerald-50 text-emerald-600", border: "hover:border-emerald-200" },
  { icon: Phone, title: "Priority Support", desc: "Direct phone line for high-priority institutional partners.", color: "bg-orange-50 text-orange-600", border: "hover:border-orange-200" }
];

const FAQS = [
  { q: "How do I file a patent through KALVEX?", a: "Our patent drafting tool automates the technical writing process. Once complete, our legal team reviews the claims before filing through our secure portal." },
  { q: "How is my data protected?", a: "To protect research integrity, all user data is anonymized and encrypted before being assigned to experts for review." },
  { q: "How can I track my orders?", a: "Live tracking is available via your Dashboard under the 'Orders' tab. You will receive real-time updates on your project status." }
];
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-400 font-bold leading-relaxed max-w-2xl mx-auto">
            Get in touch with our expert engineering and legal teams. Real experts, ready to help.
          </p>
          ...
          {[
            ...
            >
              ...
              <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-900 group-hover:text-blue-600 transition-colors">Contact Us</span>
        ...
        <div className="grid lg:grid-cols-12 gap-24 items-start">
          ...
          <div id="faq-section" className="lg:col-span-7 space-y-12">
            <div className="space-y-4">
              ...
              <p className="text-slate-400 font-black uppercase tracking-widest text-[10px]">Common Questions & Answers</p>
            </div>
            ...
            <div className="bg-slate-900 rounded-[4rem] p-12 md:p-16 text-white relative overflow-hidden group shadow-[0_64px_128px_-24px_rgba(15,23,42,0.4)] transition-all duration-500 [transform-style:preserve-3d]">
              ...
              <div className="relative z-10 space-y-12">
                <div className="space-y-4 text-center">
                  ...
                  <h2 className="text-4xl font-black font-heading tracking-tight">Direct Contact</h2>
                  <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">Get Immediate Expert Help</p>
                </div>
                ...
                <Button 
                  onClick={() => alert("Connecting you to an agent... Please wait.")}
                ...
                >
                  Contact Us Now <ArrowRight className="ml-4 w-5 h-5 group-hover:translate-x-2 transition-transform" />
                </Button>
              </div>
            </div>
