...
import { ShieldCheck, CreditCard, Smartphone, Building2, CheckCircle, Loader2, Sparkles, MapPin, ArrowRight, Shield, LogIn } from "lucide-react";
    ...
    return (
      <div className="min-h-screen pt-32 pb-24 bg-slate-50 flex items-center justify-center px-4">
        <motion.div
          initial={{ opacity: 0, scale: 0.9, y: 20 }}
          animate={{ opacity: 1, scale: 1, y: 0 }}
          className="max-w-md w-full bg-white border border-slate-100 rounded-[3rem] p-12 text-center space-y-8 shadow-2xl shadow-slate-900/5"
        >
          <div className="w-20 h-20 rounded-full bg-blue-50 flex items-center justify-center mx-auto border border-blue-100 relative">
            <LogIn className="w-8 h-8 text-blue-600" />
            <div className="absolute inset-0 rounded-full border-4 border-blue-200 animate-ping opacity-20" />
          </div>
          <div>
            <h1 className="font-heading font-black text-3xl text-slate-900 tracking-tighter mb-3">Sign in to <span className="text-blue-600">Checkout</span></h1>
          ...
          <div className="flex flex-col gap-4">
            <Button
              ...
              className="w-full bg-slate-900 hover:bg-blue-600 text-white rounded-2xl h-14 font-black text-[10px] uppercase tracking-widest transition-all duration-500 shadow-xl shadow-slate-900/20 gap-3"
            >
            ...
            <Link href="/login">
              <Button variant="outline" className="w-full border-slate-100 hover:border-blue-600/30 rounded-2xl h-14 font-black text-[10px] uppercase tracking-widest text-slate-400 hover:text-blue-600 transition-all">
                Sign in with Email
              </Button>
            </Link>
          </div>
          <Link href="/cart" className="block text-[9px] font-black text-slate-300 hover:text-blue-600 transition-colors uppercase tracking-widest">
            ← Back to Cart
          </Link>
        </motion.div>
      </div>
