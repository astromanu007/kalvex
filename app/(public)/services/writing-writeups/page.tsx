...
export default function WritingWriteupsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden font-sans">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div 
              ...
              className="space-y-8"
            >
              <div className="inline-flex items-center gap-3 bg-amber-600 text-white px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-[0.3em] shadow-2xl shadow-amber-600/20">
              ...
              <h1 className="text-6xl md:text-8xl font-black font-heading text-slate-900 leading-[0.9] tracking-tighter">
                Professional <br />
                <span className="text-amber-600">Writeups.</span>
              </h1>
                ...
                {!isSuccess ? (
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="bg-amber-50 text-amber-600 px-3 py-1 rounded-lg text-xs font-black">{pages} Pages</span>
                        </div>
                        <input 
                          type="range" 
                          min="1" 
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <button 
                          ...
                          className={`p-6 rounded-[2rem] border-2 transition-all flex flex-col items-center gap-2 ${!isUrgent ? 'border-amber-600 bg-amber-50/50 text-amber-700 shadow-lg shadow-amber-600/5' : 'border-slate-100 hover:border-slate-200 text-slate-400'}`}
                        >
                        ...
                        <button 
                          ...
                          className={`p-6 rounded-[2rem] border-2 transition-all flex flex-col items-center gap-2 ${isUrgent ? 'border-red-600 bg-red-50/50 text-red-700 shadow-lg shadow-red-600/5' : 'border-slate-100 hover:border-slate-200 text-slate-400'}`}
                        >
                      ...
                      <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 relative z-10">
                          ...
                          <Button 
                            ...
                            className={`h-16 px-10 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all w-full sm:w-auto shadow-2xl ${isUrgent ? 'bg-red-600 hover:bg-red-700 shadow-red-600/20' : 'bg-amber-600 hover:bg-amber-700 shadow-amber-600/20'}`}
                          >
                    ...
                    <p className="text-[10px] text-slate-400 font-bold text-center flex items-center justify-center gap-2">
                      <ShieldCheck className="w-4 h-4 text-emerald-500" /> Secure Institutional Transaction
                    </p>
                  </motion.div>
                ) : (
                  <motion.div 
                  ...
                  >
                    <div className="w-24 h-24 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto shadow-2xl shadow-emerald-500/20">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="space-y-4 p-8 rounded-3xl hover:bg-slate-50 transition-colors group">
                ...
                <p className="text-slate-400 font-bold leading-relaxed text-sm">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Decorative BG */}
      <div className="absolute top-0 right-0 w-[40rem] h-[40rem] bg-amber-100/30 rounded-full blur-[120px] -z-10 translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-[30rem] h-[30rem] bg-blue-100/30 rounded-full blur-[100px] -z-10 -translate-x-1/2 translate-y-1/2" />
    </div>
  );
}
