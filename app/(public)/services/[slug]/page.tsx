...
const SERVICES_DATA: Record<string, any> = {
  "professional-write-ups": { desc: "High-quality, professional technical and academic write-ups tailored to your exact requirements.", price: 5000, delivery: "7-14 Days", fields: { topicLabel: "Topic / Domain", topicPlaceholder: "e.g. Artificial Intelligence in Finance", scopeLabel: "Word Count / Scope", scopePlaceholder: "e.g. 5000 words" }, deliverables: ["Technical Report", "Plagiarism Check", "Formatting", "References"] },
